          ...
          {items.length === 0 ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-4">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2">
                          <h3 className="font-semibold text-sm text-neutral-800 leading-snug">{item.name}</h3>
                        ...
                        <div className="flex items-center justify-between mt-4">
                          <div className="flex items-center gap-2 bg-neutral-50 border border-neutral-200 rounded-lg overflow-hidden">
                            ...
                            <span className="min-w-[28px] text-center text-sm font-bold text-neutral-800">{item.qty}</span>
                            <button onClick={() => updateQty(item.id, 1)}
                              className="px-3 py-2 hover:bg-amber-50 hover:text-amber-600 transition-colors text-neutral-500">
                              <BiPlus size={14} />
                            </button>
                          ...
                          <div className="text-right">
                            ...
                            {item.qty > 1 && (
                              <div className="text-[11px] text-neutral-400">${item.price} each</div>
                            )}
                          </div>
                        </div>
                      </div>
                ...
                {/* Shipping note */}
                <div className={`flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium border ${subtotal >= 500 ? 'bg-emerald-50 border-emerald-100 text-emerald-700' : 'bg-neutral-100 border-neutral-200 text-neutral-500'}`}>
                  <FaTruck className={subtotal >= 500 ? 'text-emerald-500' : 'text-neutral-400'} />
                  {subtotal >= 500
