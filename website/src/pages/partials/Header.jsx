	...
	return (
		<header className="fixed top-0 left-0 right-0 z-50">
			...
			<div className="hidden md:flex bg-neutral-950 border-b border-white/5 py-2 px-8 justify-end items-center gap-8">
				<a href="tel:+18667009187" className="flex items-center gap-2 text-neutral-500 hover:text-amber-400 transition-colors text-xs tracking-widest uppercase font-semibold">
					<BiPhone size={13} /> 1-(866) 700-9187
				</a>
