...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setApiError(err.response?.data?.message || 'Failed to send your message. Please try again.');
    } finally {
      setSubmitting(false);
    }
  };
          ...
          <Reveal delay={0.08}>
            <div className="flex flex-wrap gap-3 mt-8">
              <a href="tel:+18667009187"
                ...
                <BiPhone className="text-amber-400" /> 1-(866) 700-9187
              </a>
                  ...
                  {submitted ? (
                    ...
                    <form onSubmit={handleSubmit} noValidate className="space-y-4">
                      ...
                      <motion.button
                        ...
                        <BiSend size={14} /> {submitting ? 'Sending...' : 'Send Message'}
                      </motion.button>
                    </form>
                  )}
                </div>
            ...
            <Reveal delay={0.05}>
              <div className="bg-white border border-neutral-200 rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  {[
                    { icon: <BiPhone size={16} className="text-amber-500" />, label: 'Phone', value: '1-(866) 700-9187', href: 'tel:+18667009187' },
