              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <div className={`flex items-center bg-neutral-50 border rounded-xl overflow-hidden focus-within:border-amber-400 transition-colors ${errors.firstName ? 'border-red-300 bg-red-50' : 'border-neutral-200'}`}>
                      <BiUser size={15} className="ml-3 text-neutral-400 flex-shrink-0" />
                ...
                <div>
                  ...
                  <div className="flex items-center bg-neutral-50 border border-neutral-200 rounded-xl overflow-hidden focus-within:border-amber-400 transition-colors">
                    <BiPhone size={16} className="ml-4 text-neutral-400 flex-shrink-0" />
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-amber-400 hover:bg-amber-500 text-neutral-900 font-black text-[13px] tracking-widest uppercase py-3.5 rounded-xl transition-colors">
                  Create Account
                </motion.button>
              </form>
