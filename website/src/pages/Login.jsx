      ...
      <div className="relative w-full max-w-md mx-auto px-4 sm:px-6 py-12">
        ...
        {submitted ? (
          <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}
            ...
            <a href="/" className="bg-amber-400 hover:bg-amber-500 text-neutral-900 font-black text-[12px] tracking-widest uppercase px-7 py-3.5 rounded-xl transition-colors inline-block">
              Go to Homepage
            </a>
          </motion.div>
        ) : (
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-4">
                ...
                <div>
                  ...
                  <div className={`flex items-center bg-neutral-50 border rounded-xl overflow-hidden transition-colors focus-within:border-amber-400 ${errors.email ? 'border-red-300 bg-red-50' : 'border-neutral-200'}`}>
                    <BiEnvelope size={16} className="ml-4 text-neutral-400 flex-shrink-0" />
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <a href="#" className="text-[11px] font-bold text-amber-500 hover:text-amber-600 tracking-wide">Forgot password?</a>
                  </div>
                  <div className={`flex items-center bg-neutral-50 border rounded-xl overflow-hidden transition-colors focus-within:border-amber-400 ${errors.password ? 'border-red-300 bg-red-50' : 'border-neutral-200'}`}>
                    <BiLock size={16} className="ml-4 text-neutral-400 flex-shrink-0" />
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-amber-400 hover:bg-amber-500 text-neutral-900 font-black text-[13px] tracking-widest uppercase py-3.5 rounded-xl transition-colors mt-2">
                  Sign In
                </motion.button>
              </form>
