...
function RequirePasswordChanged({ children }) {
  const { mustChangePassword } = useAdminAuth();
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route element={<RequireAuth><RequirePasswordChanged><AdminLayout /></RequirePasswordChanged></RequireAuth>}>
        ...
        <Route path="/employees" element={<RequirePermission path="/employees"><EmployeesPage /></RequirePermission>} />
